...
csv_name = '5_10_2025_full_run.csv'
csv_folder = 'separated_csvs_5_10_25'
...
for i in range(batch):
    ...
    layers_to_run, neurons_to_run, layers_keys, layer_cuts = mapIMACPartition_Separate_Files.mapIMAC(nodes,xbar[0],hpar,vpar,metal,T,H,L,W,D,eps,rho,weight_var,testnum_per_batch,data_dir,spice_dir,vdd,vss,tsampling)
